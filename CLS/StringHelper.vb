    ...
    If anyMatchChar Then
      If mainString.IndexOfAny(matchStr.ToCharArray) > -1 Then
        ...
        For i As Int32 = 0 To matchStr.Length - 1
          If mainString.Contains(matchStr.ElementAt(i)) AndAlso mainString.IndexOf(matchStr.ElementAt(i)) < start Then
...
#Region "StrIncrement()"
  ...
  Public Shared Function StrIncrement(ByVal mainString As String) As String
    ...
    For x = mainString.Length To 1 Step -1
      ...
      If (sChar >= "0") AndAlso (sChar <= "8") Then
      ...
      ElseIf sChar = "9" Then
        sChar = "0"
        MID$(mainString, x, 1) = sChar
      ElseIf (sChar >= "A") AndAlso (sChar <= "Y") Then
        sChar = Chr(Asc(sChar) + 1)
        MID$(mainString, x, 1) = sChar
        Exit For
      ElseIf sChar = "Z" Then
...
#Region "UnWrap()"
  ...
  Public Shared Function UnWrap(ByVal text As String, ByVal leftChar As String, Optional ByVal rightChar As String = "") As String
    ...
    If (text.Length > leftChar.Length AndAlso text.StartsWith(leftChar)) Then
    ...
    If (text.Length > leftChar.Length AndAlso text.EndsWith(leftChar)) Then
